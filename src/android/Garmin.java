...
public class Garmin extends CordovaPlugin {
	public static final String TAG = "Garmin Plugin";
	...
	private abstract class GarminRunnable implements Runnable {
		public CallbackContext callbackContext;
		GarminRunnable(CallbackContext cb) {
	...
	private boolean canLaunch(JSONArray args) throws JSONException {
		...
		if (options.has("packageName")) {
			...
			cordova.getThreadPool().execute(new GarminRunnable(this.callback) {
				public void run() {
